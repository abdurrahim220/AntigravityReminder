...
// === THUNKS ===
export const addReminderAndPersist =
  (reminder: Reminder) =>
...
export const deleteReminderAndPersist =
  (id: string) => async (dispatch: AppDispatch, getState: () => RootState) => {
    await notifee.cancelNotification(id); // 👈 ADD THIS
...
export const updateReminderAndPersist =
  (reminder: Reminder) =>
  async (dispatch: AppDispatch, getState: () => RootState) => {
...
export const toggleReminderAndPersist =
  (id: string) => async (dispatch: AppDispatch, getState: () => RootState) => {
    dispatch(reminderSlice.actions.toggleReminderStatus(id));

    const reminder = getState().reminder.reminders.find(r => r.id === id);
...
export const checkAutoResetsAndPersist =
  () => async (dispatch: AppDispatch, getState: () => RootState) => {
